public class Decoder {
  ...
  private static String decodeRType(int instruction) {
    ...
    int funct3 = (instruction >> 12) & 0x7; // Used to find which instruction from the Type is being called in the function
    int funct7 = (instruction >> 25) & 0x7F;// Usually is used in the Immediate or signal control in operation.
